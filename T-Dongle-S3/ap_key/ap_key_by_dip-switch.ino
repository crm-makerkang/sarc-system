...
void normal_setup(){
  ...
  WiFi.softAP(ssid, password, read_channel(), 0, 8); // ssid, passphrase, channel, ssid_hidden, max_connection
                                        // Remove the password parameter, if you want the AP (Access Point) to be open

  IPAddress IP(apip_1, apip_2, apip_3, apip_4);
  IPAddress NMask(255, 255, 255, 0);
  WiFi.softAPConfig(IP, IP, NMask); //local_IP, gateway, subnet
